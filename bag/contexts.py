...
from products.models import Product
 # Ensure you import the Product model

def bag_contents(request):
    
    """
    Function to calculate and return the contents of the shopping bag, 
    including total price, delivery charges, and free delivery threshold details.
    """
    bag_items = []
    ...
    for item_id, item_quantity in bag.items():
        ...
        item_total = item_quantity * product.price  # Accumulate the total price
        total += item_total
    ...
    return {
        ...
        'FREE_DELIVERY_THRESHOLD': settings.FREE_DELIVERY_THRESHOLD,  # Make sure this is in settings.py
    }
